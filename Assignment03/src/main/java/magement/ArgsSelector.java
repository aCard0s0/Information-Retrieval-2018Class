...
import operations.io.AmazonReader;
import operations.io.CorpusReader;
import operations.io.XMLReader;
...
public class ArgsSelector {
    ...
    private void parseOptions() {
        ...
        try {
            ...
            if (cmd.hasOption("cramazon")) {
                this.creader = new AmazonReader( cmd.getOptionValue("cramazon") );
            }
    ...
    public void showStartMessage() {
        ...
        if (this.creader instanceof AmazonReader){
            msg += "\tUsing AmazonReader at file: "+ this.creader.getSrcPath() +"\n";

        } else if (this.tokens instanceof XMLReader) {
            msg += "\tUsing XMLReader at the folder: "+ this.creader.getSrcPath() +"\n";
        }
